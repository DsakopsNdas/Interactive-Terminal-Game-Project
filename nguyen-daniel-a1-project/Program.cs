//Initialize most variables here to ensure they're properly set when game starts
int affection = 0;
int actions = 10;
...
if (correctFirstChoice == true)
{
    ...
    actions--;
} else if (correctFirstChoice == false)
{
